...
namespace VxTel.Api.Test.Domain.DTO
{
    public class ChamadaDTOTest
    {
        ...
        public void CreateDTO_ValidateSetParameters_OK()
        {
            ...
            var chamada = new ChamadaDTO(1, 1001, "031", 123456789, "011", 987654321, date, date.AddMinutes(10), new TimeSpan(1, 30, 0), 123.45);
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(chamada.DataHoraFim, Is.EqualTo(date.AddMinutes(10)));
